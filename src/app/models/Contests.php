...
class Contests extends ActiveRecord
{
    ...
    const SCENARIO_INSTITUTIONAL_PROYECT = 'institutional_project';
    ...
    public function scenarios()
    {
        ...
        $scenarios[self::SCENARIO_INSTITUTIONAL_PROYECT] = ['remuneration_type_id', 'working_day_type_id', 'category_type_id', 'institutional_project_id'];
    ...
    public function rules()
    {
        return [
            ...
            [['remuneration_type_id', 'working_day_type_id', 'category_type_id', 'institutional_project_id'], 'required', 'on' => self::SCENARIO_INSTITUTIONAL_PROYECT],
            ...
            [['institutional_project_id'], 'exist', 'skipOnError' => true, 'targetClass' => InstitutionalProyect::class, 'targetAttribute' => ['institutional_project_id' => 'id']],
        ];
    }
   ...
   /**
    ...
    {
        return $this->hasOne(InstitutionalProyect::class, ['id' => 'institutional_project_id']);
    }
